...
import './globals.css';
import {AppConnection,InstallProvider} from '@/components/install-app';
...
export const viewport:Viewport={themeColor:'#292639',width:'device-width',initialScale:1};
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="en"><body><InstallProvider><AppConnection/>{children}</InstallProvider></body></html>;}
